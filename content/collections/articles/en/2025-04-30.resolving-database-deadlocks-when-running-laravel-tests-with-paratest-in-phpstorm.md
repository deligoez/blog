...
updated_at: 1766433070
og_generator_image: resolving-database-deadlocks-when-running-laravel-tests-with-paratest-in-phpstorm.jpg
show_toc: false
content:
  -
    type: set
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Illuminate\Database\QueryException: SQLSTATE[40001]: Serialization failure: 1213 Deadlock found when trying to get lock; try restarting transaction'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: LARAVEL_PARALLEL_TESTING=1;LARAVEL_PARALLEL_TESTING_RECREATE_DATABASES=1
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Testing Without Deadlocks'
  -
    type: paragraph
    attrs:
      textAlign: left
