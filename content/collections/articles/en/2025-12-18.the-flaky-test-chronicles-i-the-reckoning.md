...
content:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: "You have features to ship, deadlines to meet, and a backlog that won't wait for your test infrastructure."
      -
        type: hardBreak
      -
        type: text
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: '76 flaky failures went to zero.'
      -
        type: text
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' These were risky tests - tests without assertions. PHPUnit was literally telling us '
      -
        type: text
        marks:
          -
            type: italic
        text: '"this test proves nothing"'
      -
        type: text
        text: " and we ignored it. A test that doesn't assert anything is not a test. It's a lie you tell CI."
  -
    type: paragraph
    attrs:
      textAlign: left
    content:
      -
        ...
        marks:
          -
            type: bold
        text: '53 alias and overload mocks killed.'
      -
        type: text
        text: ' Every one of them was a parallelization time bomb. We replaced them with the container binding pattern (covered in '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: '). This took the most effort but had the biggest impact on CI reliability.'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' And look, I get it. Debugging flaky tests is '
      -
        type: text
        marks:
          -
            type: italic
        text: 'soul-crushing work'
      -
        type: text
        text: '. But ignoring them is '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: 'Same code. Same data. Different day.'
  -
    type: set
    attrs:
      id: mjc26hy2
            ...
            content:
              ...
              -
                ...
                marks:
                  -
                    type: italic
                text: '"I enjoy debugging timezone issues on a holiday weekend"'
              -
                type: text
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: "\"But what if I use the random value in my assertion too?\" Nice try. Now your test always passes, but you can't reproduce failures, you don't know which value caused issues, and you're not explicitly testing edge cases. You've just written a test that proves nothing deterministically."
        style: note
        position: right
  -
    type: paragraph
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ' You mocked a config value. Another test has cached config. Your mock gets ignored. (See '
              -
                type: text
                marks:
                  -
                    type: link
                    attrs:
                      href: /articles/the-flaky-test-chronicles-iv-the-teardown-tango#the-cache-vs-mock-race
                      rel: null
                      target: null
                      title: null
                text: 'Part 4: The Cache vs Mock Race'
              -
                type: text
                text: ')'
      -
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: "Alias mocks modify PHP's global class autoloader. When two tests try to do this simultaneously for the same class, they collide. It's not a bug in Mockery. It's a fundamental limitation of how alias mocking works. We'll cover this in gory detail in "
              -
                type: text
                marks:
                  -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: " Don't use alias mocks. Use the factory pattern instead. We dedicated all of "
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' to this because we had to kill 43 of them.'
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '. An observer fires on create and sets their role. Another test disabled event dispatching. Your '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' has no role. Your test fails.'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: " is where Mockery shows its dark side. We had 53 alias and overload mocks across multiple test files. Every single one of them was a ticking time bomb in parallel execution. We'll cover:"
  -
    type: bulletList
    content:
      -
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Why alias and overload mocks are fundamentally broken for parallel testing'
      -
        type: listItem
        content:
          -
            ...
            content:
              -
                type: text
                text: 'The container binding pattern that saved us'
      -
        type: listItem
        content:
          -
