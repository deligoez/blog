...
content:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' Every one of them was a parallelization time bomb. We replaced them with the container binding pattern (covered in Part 2). This took the most effort but had the biggest impact on CI reliability.'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: "Part 2 is where Mockery shows its dark side. We had 53 alias and overload mocks across multiple test files. Every single one of them was a ticking time bomb in parallel execution. We'll cover:"
  -
    type: bulletList
    content:
      -
