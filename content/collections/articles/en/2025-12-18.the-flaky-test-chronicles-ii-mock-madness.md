...
content:
  -
    ...
    content:
      -
        type: text
        text: 'Making Mockery Parallel-Safe'
  -
    type: paragraph
    attrs:
      textAlign: left
    content:
      -
        ...
        marks:
          -
            type: italic
        text: 'The Flaky Test Chronicles, Part 2: Mock Madness'
  -
    type: blockquote
    content:
      -
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.sidenote} There''s a special circle of debugging hell reserved for errors that only happen in CI. Right next to "works on my machine." {/sidenote}'
  -
    type: horizontalRule
  -
    type: heading
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: " - Breakpoints and var_dump don't work"
      -
        type: listItem
        content:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: " is like solving a flat tire by buying a new car. It works, technically. It's just 10-100x more expensive. {/warning}"
  -
    type: paragraph
    attrs:
      textAlign: left
    content:
      -
        type: text
        text: '{.sidenote} In a suite of 10,000 tests, separate process for each test = hours. A test takes 100ms, process spawn takes 500ms. The math is terrible. {/sidenote}'
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.note} Need for alias mocks = refactoring opportunity. Making production code more testable is better than hacking tests. {/note}'
  -
    type: horizontalRule
  -
    type: heading
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'The Pattern to Avoid (With Tears)'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.warning} Why did we remove return types? PHP 8.2+ '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: " classes can't be extended. Mockery can't create typed mocks of these classes. Removing the return type lets Mockery return a generic mock. {/warning}"
  -
    type: heading
    attrs:
      textAlign: left
    ...
    content:
      -
        ...
        text: |
          ...
          Mockery::mock('overload:ParatikaClient')
              ->shouldReceive('sendRequest')
              ->andReturn($response);

          // Use container binding:
          $mock = Mockery::mock(ParatikaClient::class);
          $mock->shouldReceive('sendRequest')
              ->once()
              ->andReturn($response);

          $this->app->bind(ParatikaClient::class, fn () => $mock);
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: "{.note} Container binding only works if the production code resolves the class through Laravel's container ("
      -
        type: text
        marks:
          -
            type: code
        text: 'app(ParatikaClient::class)'
      -
        type: text
      ...
      -
        ...
        marks:
          -
            type: code
        text: 'new ParatikaClient()'
      -
        type: text
        text: " calls won't be intercepted. {/note}"
  -
    type: horizontalRule
  -
    type: heading
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.sidenote} You can document the return type with PHPDoc. IDEs and static analyzers can read PHPDoc. No runtime type enforcement, but Mockery works. {/sidenote}'
  -
    type: horizontalRule
  -
    type: heading
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Avoid @runInSeparateProcess'
  -
    type: paragraph
    attrs:
      textAlign: left
    content:
      ...
      -
        type: text
        text: " might seem tempting. Don't."
  -
    type: paragraph
    attrs:
      textAlign: left
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ' Each test = new PHP process = 10-100x slower'
      -
        type: listItem
        content:
          -
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ' Each process reloads framework'
      -
        type: listItem
        content:
          -
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'When you think you need it:'
  -
    type: bulletList
    content:
      -
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Using alias mocks → Switch to factory pattern'
      -
        type: listItem
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Testing static state → Use dependency injection'
      -
        type: listItem
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Global state conflict → Fix in '
              -
                type: text
                marks:
                  -
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: "When it's actually necessary:"
  -
    type: bulletList
    content:
      -
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Testing code that intentionally modifies PHP global state (rare)'
      -
        type: listItem
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Testing exit/die behavior (very rare)'
  -
    type: paragraph
    attrs:
      textAlign: left
    content:
      -
        type: text
        text: '{.warning} When you reach for '
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ', treat it as a code smell. Making production code more testable is the right solution. {/warning}'
  -
    type: horizontalRule
  -
    type: heading
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Mockery Best Practices (The Foundation)'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: |
          BulutTahsilat::shouldReceive('updatePaymentStatusInfoWithPaymentExpCode')
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.note} This change affected 37+ test files. A big refactoring but worth it. {/note}'
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: 'When using DataProviders, not every test case runs the same code path.'
  -
    type: paragraph
    attrs:
      textAlign: left
      ...
      -
        ...
        text: |
          ...
          public function test_suspend_previous_applications(ApplicationStatus $status): void
          {
              ...
              FibaMock::cancelApplication(true);
        ...
        text: |
          ...
          public function test_suspend_previous_applications(ApplicationStatus $status): void
          {
              $statusesThatTriggerCancellation = [
                  ApplicationStatus::FIBA_DECISION_WAITING,
                  ApplicationStatus::FIBA_PIN_WAITING,
              ];
    ...
    content:
      -
        ...
        text: |
          ...
          FibaMock::storeApplicant(true, [  // This will fail!
    ...
    content:
      -
        ...
        text: |
          ...
          // FibaMock not needed - job doesn't execute
