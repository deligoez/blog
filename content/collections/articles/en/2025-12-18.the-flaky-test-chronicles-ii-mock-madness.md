...
content:
    ...
    content:
      ...
      -
        ...
        marks:
          -
            type: bold
        text: 'Mockery alias and overload mocks.'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Why Alias and Overload Mocks Are the Enemy'
  -
    type: paragraph
    attrs:
      textAlign: left
    content:
      ...
      -
        type: text
        text: ' prefixes let you mock static methods and class instantiation. Sounds great. But they have serious problems.'
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Both alias and overload mocks '
      -
        type: text
        marks:
          -
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: 'For the official explanation, see Mockery '
              -
                type: text
                marks:
                  -
              ...
              -
                type: text
                text: ' on mocking hard dependencies.'
        style: note
        position: right
  -
    type: heading
  ...
  -
    ...
    content:
      -
        type: text
        text: "This is why alias and overload mocks and parallel testing are fundamentally incompatible—not because Mockery is broken, but because PHP's class system doesn't support class unloading."
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: 'The only safe way to use alias or overload mocks is with '
      -
        type: text
        marks:
          -
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: 'Need for alias or overload mocks = refactoring opportunity. Making production code more testable is better than hacking tests.'
        style: note
        position: right
  -
    type: heading
  ...
  -
    ...
    content:
      -
        type: text
        text: 'If you need alias or overload mocks, your code is tightly coupled to static calls. This is a '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: '. The only way to mock them is with alias or overload mocks, which brings us back to the parallel-unsafe territory.'
  -
    type: horizontalRule
  -
    type: heading
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Good news: there are multiple ways out of alias and overload mock hell. Bad news: none of them are free.'
  -
    type: set
    attrs:
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: 'We discovered that PaymentProcessor::default() returns AbstractPaymentCalculator, not PaymentProcessor. This required a separate binding for that class too.'
        style: warning
        position: right
  -
    type: paragraph
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ' instead of alias or overload mock'
      -
        type: listItem
        content:
          -
            ...
            content:
              -
                ...
                content:
                  -
                    type: text
                    text: Feature/OrderPaymentControllerTest
          -
            type: tableCell
            attrs:
              colspan: 1
            ...
            content:
              -
                ...
                content:
                  -
                    type: text
                    text: Feature/PriceCalculatorControllerTest
          -
            type: tableCell
            attrs:
              colspan: 1
            ...
            content:
              -
                ...
                content:
                  -
                    type: text
                    text: Feature/ApplicationControllerTest
          -
            type: tableCell
            attrs:
              colspan: 1
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Beyond alias and overload mocks, here are the fundamental rules of Mockery usage:'
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ', we explored the six deadly sins of flaky tests and why your CI fails at random.'
  -
    type: paragraph
    attrs:
      textAlign: left
    ...
    content:
      -
        ...
        marks:
          -
            type: italic
        text: 'The Flaky Test Chronicles is a series documenting what we learned from 300+ commits of test suite cleanup. Remember: alias mocks are forever. Or until the process dies.'
---
