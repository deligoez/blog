...
content:
  -
    ...
    content:
      -
        type: text
        text: 'The Art of Test Cleanup and Assertion Patterns'
  -
    type: paragraph
    attrs:
      textAlign: left
    content:
      -
        ...
        marks:
          -
            type: italic
        text: 'The Flaky Test Chronicles, Part 4: The Cleanup'
  -
    type: blockquote
    content:
      -
        ...
        content:
          -
            type: text
            text: 'One line in tearDown(). Wrong order. 200 tests fail. Nobody knows why.'
  -
    type: horizontalRule
  -
    type: heading
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: " last. Unless you enjoy debugging why your cleanup code can't access things that no longer exist. {/warning}"
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.sidenote} Trait explosion is a symptom, not a solution. Centralize in TestCase. {/sidenote}'
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: "{.sidenote} This is defensive programming. You don't need to know which test mocked what. You just clean up everything, every time. {/sidenote}"
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: 'You might think: "If the problem is facade mocking corrupting Sushi connections, why not just use '
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.note} Config is cached. You mock Config. The cached version wins. Your mock loses. You lose an hour. {/note}'
  -
    type: horizontalRule
  -
    type: heading
  ...
  -
    ...
    content:
      -
        type: text
        text: 'In your base TestCase, disable observable events for models that have side effects:'
  -
    type: codeBlock
    attrs:
      language: null
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.note} Events, notifications, and observers should be opt-in during tests, not opt-out. Your test should control its side effects. {/note}'
  -
    type: horizontalRule
  -
    type: heading
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: " in parallel tests? You're playing musical chairs with HTTP responses. Don't. {/warning}"
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Fake BEFORE you trigger. Always.'
  -
    type: codeBlock
    attrs:
      language: null
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Laravel Passport requires OAuth clients to be created before authentication tests can work. For full authentication architecture including helper methods and multi-guard setup, see Part 5.'
  -
    type: heading
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: "{.note} 403 Forbidden. No, your endpoint isn't broken. Your token doesn't have the scope. Check your test setup. {/note}"
  -
    type: horizontalRule
  -
    type: heading
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: " is cleaner. The try/catch pattern has its place, but it's not your first choice. {/tip}"
  -
    type: horizontalRule
  -
    type: heading
  ...
  -
    ...
    content:
      -
        type: text
        text: 'PHPUnit marks tests as "risky" when they have no assertions. This often indicates a problem with the test.'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: "{.note} A test without assertions is not a test. It's a lie you tell CI. {/note}"
  -
    type: horizontalRule
  -
    type: heading
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Common Pitfalls (The Greatest Hits)'
  -
    type: paragraph
    attrs:
      textAlign: left
            ...
            content:
              -
                ...
                marks:
                  -
                    type: bold
                text: 'assertDatabaseHas with JSON'
              -
                type: text
            ...
            content:
              -
                ...
                marks:
                  -
                    type: bold
                text: 'assertSee vs assertSeeText'
              -
                type: text
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ' causes "class already exists" errors; use factory pattern.'
      -
        type: listItem
        content:
          -
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ') must set it explicitly in setUp and reset in tearDown. Consider a trait like '
              -
                type: text
                marks:
                  -
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ' trait is in base TestCase'
      -
        type: listItem
        content:
          -
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Every flaky test is a deterministic bug waiting to be found. Every "just rerun it" is technical debt you''re taking on with interest.'
  -
    type: paragraph
    attrs:
      textAlign: left
  ...
  -
    ...
    content:
      -
        type: text
        text: '{.sidenote} "It works on my machine" is not a test strategy. "It works in CI, repeatedly, in parallel, in random order" is. {/sidenote}'
  -
    type: horizontalRule
  -
    type: heading
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: 'Part 5: The Foundation'
      -
        type: text
        text: ' will cover the test infrastructure itself:'
  -
    type: bulletList
    content:
      -
