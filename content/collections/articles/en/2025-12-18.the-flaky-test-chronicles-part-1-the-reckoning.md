...
content:
  ...
  -
    ...
    attrs:
      ...
      values:
        type: sidenote
        content: 'Senior developer definition: Someone who knows exactly which flaky test to ignore and which one is hiding a production bug waiting for the weekend.'
        style: note
        position: right
  -
    type: paragraph
